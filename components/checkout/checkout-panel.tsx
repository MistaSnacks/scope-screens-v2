...
// The whole ticket-buying flow (load tiers → pick quantities → reserve → pay
// redirect), extracted from CheckoutModal so the /events/[slug] page can embed
// it inline. The modal wraps this same panel, so both surfaces stay identical.
...
export function CheckoutPanel({
  ...
  /** Lets a host dialog block its close affordances mid-checkout. */
